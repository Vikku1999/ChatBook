<?php
    ...
    class BlogMember extends BlogReader{
        ...
        public function isDuplicateID(){
            ...
            $sql = "SELECT count(username) AS num FROM member WHERE username = :username";
        ...
        public function updateLastViewedPost(){
            ...
            $sql = "UPDATE member SET last_viewed = :max WHERE username = :username";
        ...
        public function getLastViewedPost(){
            $sql = "SELECT last_viewed FROM member WHERE username = :username";
